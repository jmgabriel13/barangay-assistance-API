...
namespace Base.Entities.Migrations
{
    ...
    [Migration("20220402121630_RemoveRequiredInvolvedProperty")]
    partial class RemoveRequiredInvolvedProperty
    {
            ...
            modelBuilder.Entity("Base.Entities.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Age = 20,
                            BirthDate = new DateTime(2022, 4, 2, 20, 16, 28, 958, DateTimeKind.Local).AddTicks(7211),
                            BirthPlace = "Tabi tabi",
                            CreatedBy = 0,
                            DateCreated = new DateTime(2022, 4, 2, 20, 16, 28, 959, DateTimeKind.Local).AddTicks(952),
                            ...
                            Position = 1,
                            Purok = "Purok 1",
                            TermFrom = new DateTime(2022, 4, 2, 20, 16, 28, 958, DateTimeKind.Local).AddTicks(9508),
                            TermTo = new DateTime(2023, 4, 2, 20, 16, 28, 958, DateTimeKind.Local).AddTicks(9915),
                            UpdatedBy = 0,
                            Username = "admin"
                        });
                });
